...
public class ContinuumWorkerTest {
    ...
    private static final String DESCRIPTION = "Build Definition Generated By Maestro 4, task ID: " + TASK_ID;
    ...
    private void setupBuildProjectMocks(int projectId, int buildDefId, String projectName, ProjectGroupSummary group, int buildId)
        ...
        buildDef.setDescription(DESCRIPTION);
        ...
        ProjectSummary checkoutProject = new ProjectSummary();
        checkoutProject.setId(projectId);
        checkoutProject.setState(ContinuumProjectState.CHECKING_OUT);

        ProjectSummary updatingProject = new ProjectSummary();
        updatingProject.setId(projectId);
        updatingProject.setState(ContinuumProjectState.UPDATING);
        ...
        when(continuumXmlRpcClient.getProjectSummary(projectId)).thenReturn(project, checkoutProject, updatingProject, buildingProject, completedProject);
    ...
    @SuppressWarnings("unchecked")
    private void setupTaskId(JSONObject fields) {
        JSONObject params = new JSONObject();
        params.put(ContinuumWorker.PARAMS_COMPOSITION_TASK_ID, TASK_ID);
        fields.put("params", params);
    }

    @SuppressWarnings("unchecked")
    @Test
    public void testBuildQueued() throws Exception {
        int projectId = 1;
        int buildDefId = 1;
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testBuildQueuedTimeout() throws Exception {
        int projectId = 1;
        int buildDefId = 1;

        setupBuildProjectMocks(projectId, buildDefId, "HelloWorld", createProjectGroup());

        continuumWorker.setBuildStartTimeout(400);
